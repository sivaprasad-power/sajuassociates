...
/* themes/custom/january/templates/form/details.html.twig */
class __TwigTemplate_3e718ebf72004c3e3407a24a6fa820fb extends Template
{
    private $source;
    private $macros = [];
...
";
    ...
    {
        return "themes/custom/january/templates/form/details.html.twig";
    }
 ...
 * @see january_preprocess_details()
 */
#}
{#
...
<details{{ attributes.addClass(classes) }}>
  ...
  <div{{ content_attributes.addClass(content_wrapper_classes) }}>
    ...
    {% endif %}
    {%- if description -%}
      <div class=\"january-details__description\">{{ description }}</div>
    {%- endif -%}
    {%- if children -%}
      {{ children }}
    {%- endif -%}
...
", "themes/custom/january/templates/form/details.html.twig", "/home/user/public_html/siva-new-demo/web/themes/custom/january/templates/form/details.html.twig");
    }
