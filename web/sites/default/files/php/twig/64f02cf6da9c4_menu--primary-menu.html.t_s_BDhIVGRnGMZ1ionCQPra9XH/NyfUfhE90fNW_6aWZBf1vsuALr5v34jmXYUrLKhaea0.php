...
/* themes/custom/january/templates/navigation/menu--primary-menu.html.twig */
class __TwigTemplate_1acaa286b4c5e6925af95e0e6872c959 extends Template
{
    private $source;
    private $macros = [];
...
($context["is_top_level_menu"] ?? null) && twig_get_attribute($this->env, $this->source, $context["item"], "below", [], "any", false, false, true, 129))) ? ("primary-nav-submenu-toggle-button") : (false))]), "html", null, true);
  ...
  ";
    ...
    {
        return "themes/custom/january/templates/navigation/menu--primary-menu.html.twig";
    }
...
/**
 * @file
 * january's theme implementation for the menus in the primary_menu region.
 *
 * Available variables:
 ...
 */
#}
{{ attach_library('january/navigation-primary') }}
...
{% macro menu_links(items, attributes, menu_level, aria_id) %}
  ...
  {% endif %}
{% endmacro %}
", "themes/custom/january/templates/navigation/menu--primary-menu.html.twig", "/home/user/public_html/siva-new-demo/web/themes/custom/january/templates/navigation/menu--primary-menu.html.twig");
    }
