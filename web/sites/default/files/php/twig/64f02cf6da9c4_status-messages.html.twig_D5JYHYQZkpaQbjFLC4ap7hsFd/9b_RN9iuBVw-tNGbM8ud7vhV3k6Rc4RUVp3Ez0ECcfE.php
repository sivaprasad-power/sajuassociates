...
/* themes/custom/january/templates/misc/status-messages.html.twig */
class __TwigTemplate_f111d2988fa4087a1eb1d70c7329ca9f extends Template
{
    private $source;
    private $macros = [];
            ...
            <h2 class=\"visually-hidden\">";
              ...
              <div class=\"messages__icon\">
                ...
                if (($context["type"] == "error")) {
                    // line 47
                    echo "                  ";
                    $this->loadTemplate("@january/../images/error.svg", "themes/custom/january/templates/misc/status-messages.html.twig", 47)->display($context);
                    // line 48
                    echo "                ";
                } elseif (($context["type"] == "warning")) {
                    // line 49
                    echo "                  ";
                    $this->loadTemplate("@january/../images/warning.svg", "themes/custom/january/templates/misc/status-messages.html.twig", 49)->display($context);
                    // line 50
                    echo "                ";
                } elseif (($context["type"] == "status")) {
                    // line 51
                    echo "                  ";
                    $this->loadTemplate("@january/../images/status.svg", "themes/custom/january/templates/misc/status-messages.html.twig", 51)->display($context);
                    // line 52
                    echo "                ";
                } elseif (($context["type"] == "info")) {
                    // line 53
                    echo "                  ";
                    $this->loadTemplate("@january/../images/info.svg", "themes/custom/january/templates/misc/status-messages.html.twig", 53)->display($context);
                    // line 54
                    echo "                ";
                }
                // line 55
...
";
    ...
    {
        return "themes/custom/january/templates/misc/status-messages.html.twig";
    }
 ...
 */
#}
{{ attach_library('january/messages') }}
        ...
        <div class=\"messages__container\" data-drupal-selector=\"messages-container\"{% if type == 'error' %} role=\"alert\"{% endif %}>
          {% if status_headings[type] %}
            ...
            <h2 class=\"visually-hidden\">{{ status_headings[type] }}</h2>
              <div class=\"messages__icon\">
                {% if type == 'error' %}
                  {% include \"@january/../images/error.svg\" %}
                {% elseif type == 'warning' %}
                  {% include \"@january/../images/warning.svg\" %}
                {% elseif type == 'status' %}
                  {% include \"@january/../images/status.svg\" %}
                {% elseif type == 'info' %}
                  {% include \"@january/../images/info.svg\" %}
                {% endif %}
              </div>
            </div>
          {% endif %}
...
", "themes/custom/january/templates/misc/status-messages.html.twig", "/home/user/public_html/siva-new-demo/web/themes/custom/january/templates/misc/status-messages.html.twig");
    }
