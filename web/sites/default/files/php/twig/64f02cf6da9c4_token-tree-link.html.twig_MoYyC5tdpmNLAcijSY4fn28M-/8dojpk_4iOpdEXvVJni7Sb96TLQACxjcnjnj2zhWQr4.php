...
class __TwigTemplate_e29813102d380052dd6467052f31f105 extends Template
{
    private $source;
    private $macros = [];
...
{% if link -%}
  {{ link }}
{%- endif %}
", "modules/contrib/token/templates/token-tree-link.html.twig", "/home/user/public_html/siva-new-demo/web/modules/contrib/token/templates/token-tree-link.html.twig");
    }
